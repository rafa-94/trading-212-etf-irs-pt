...
export function Logo({ className }: LogoProps) {
  return (
    <a href="#" className={cn("flex items-center gap-2", className)}>
      <div className="flex h-8.5 w-8.5 items-center justify-center rounded-lg bg-fis-accent text-fis-bg">
      ...
      <span className="font-serif font-bold text-lg tracking-tight text-fis-text">
        Fiscus
      </span>
    </a>
  )
